...
| Новый функционал | ➕ 4 цветовых статуса для Wi-Fi (красный, оранжевый, зеленый, серый/не отображать) |
| Новый функционал | ➕ 4 цветовых статуса для Mobile (красный, оранжевый, зеленый, серый/не отображать) |
